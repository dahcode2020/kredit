...
if (!layout.includes("kredit-dev-sw-heal")) {
  pRouge(
...
if (html.erreur) {
  ...
  else if (html.corps) pRouge("Le HTML servi ne contient pas « kredit-dev-sw-heal » alors que app/layout.tsx le rend: ce serveur a été démarré avant le pull. Redémarrez-le (npm run fresh).");
