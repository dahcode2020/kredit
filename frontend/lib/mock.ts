...
export const mockNotifs = [
  { id:'N1', channel:'EMAIL', title:'Dossier KRD-2026-0842 en revue', body:'Votre dossier est en analyse administrative', date:'2026-09-09T14:22:00+02:00', read:false },
  { id:'N2', channel:'PUSH', title:'Document vérifié', body:'Votre carte identité a été vérifiée', date:'2026-09-08T09:11:00+02:00', read:true },
  { id:'N3', channel:'SMS', title:'Rappel échéance', body:'Échéance 463€ le 01/10', date:'2026-09-07T08:00:00+02:00', read:false },
];
