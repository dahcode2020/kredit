      ...
      <div className="max-w-[700px] space-y-6">
        ...
        <div className="bg-white rounded-2xl border p-6 space-y-4">
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="bg-surface rounded-xl p-3"><div className="text-xs tracking-widest uppercase font-bold text-slate-500">Valeur</div><div className="font-extrabold">{formatEUR2(5000,"fr-BE")}</div></div>
